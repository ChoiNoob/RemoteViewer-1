...
import com.damintsev.gwt.common.source.Callback;
import com.damintsev.gwt.client.source.event.FileUploadEvent;
import com.damintsev.gwt.client.source.event.FileUploadHandler;
...
//        if(instance == null)
    ...
    private Image image;
    private com.damintsev.gwt.client.source.uientity.Image loadedImage;
    ...
    protected FileUploadWindow() {
        ...
        EventBus.get().addHandler(FileUploadEvent.TYPE, new FileUploadHandler() {
            ...
            public void onFileUpload(FileUploadEvent event) {
                ...
                Service.instance.loadTemporaryImage(event.getFileId(), new Callback<com.damintsev.gwt.client.source.uientity.Image>() {
                    @Override
                    protected void onFinish(com.damintsev.gwt.client.source.uientity.Image result) {
    ...
    public static native void addCallbackListener()/*-{
        $wnd.jsniCallback = function (id) {
            @com.damintsev.gwt.client.source.v3.pages.windows.FileUploadWindow::fileCallback(Ljava/lang/String;)(id)
        };
    }-*/;
