...
public class Scheduler {
    ...
    Map<Station, List<MyInter>> stationDevices;
    List<MyInter> errorList;
    ...
    public void scheduler() {
        for(Map.Entry<Station, List<MyInter>> entry : stationDevices.entrySet()) {
            Station station = entry.getKey();
            Telnet telnet = getConnection(station);
            for(MyInter devices : entry.getValue()) {
